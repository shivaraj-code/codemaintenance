...
public class S3Service {
	...
	private String processedFolderName;
	 ...
	 private AmazonS3 s3Service = null;
	    ...
	    public String saveCodeZipFile(String zipFilename, String targetCodeTypeFolderName,InputStream zipFileStream) throws IOException {
	        ...
	        log.info(MessageFormat.format("File saved in S3 Bucket: Buket Name:{0} and File Name:{1}",bucketName,zipFilename));
	    ...
	    public String isFileExistInS3Bucket(String fileName, String targetCodeStandardFolder) {
			...
			//System.out.println("$$$$$$$$$$$$$$$$$$$$"+uploadFolderPath +":"+inprocessFolderPath +":"+processedFolderPath);
	    ...
	    public CustomResponse deleteFileInS3Bucket(String filePath) {
			...
			try {
				...
				log.error(e.getLocalizedMessage());
				return new CustomResponse("File Delete Failed with Key:" + filePath,e.getLocalizedMessage(),HttpStatus.INTERNAL_SERVER_ERROR);
			}
